...
public class L1_ContadorMT_Runnable implements Runnable{
	...
	//Metodo constructor
	public L1_ContadorMT_Runnable(Integer pNum, Integer pLimit) {
	...
	public static void main (String[] args) {
		...
		Thread t0 = new Thread(new L1_ContadorMT_Runnable(1,limit));
		Thread t1 = new Thread(new L1_ContadorMT_Runnable(2,limit));
